		...
		<div class="content">
			<form action="write.do" method="post" id="writeForm">
				<div class="user-details">
					<div class="input-box">
						<span class="details">Name</span> <input id="name" name="name" placeholder="이름 입력" autocomplete="off" required>
					</div>
					<div class="input-box">
						<span class="details">Email</span> <input id="email" name="email" autocomplete="off" placeholder="예)test@naver.com" required>
					</div>
					<div class="input-box">
						<span class="details">ID</span> <input id="id" name="id" pattern="[A-Za-z0-9]{4,20}" autocomplete="off" placeholder="아이디 입력" required>
						<div class="alert alert-danger" id="idCheckDiv">ID는 4자 이상 입력하셔야 합니다.</div>
					</div>
					<div class="input-box">
					...
					<div class="input-box">
						<span class="details">Address</span> <input class="address_input_1" type="text" id="addr1" name="addr1" placeholder="주소 입력" readonly="readonly" required>
						<div class="address_button" onclick="execution_daum_address()"> <span class="btn btn-default btn-sm">주소 찾기</span></div>
					</div>
					<div class="input-box">
					...
					<div class="input-box">
						<span class="details"></span> <input type="text" name="addr2" placeholder="상세주소 입력" class="address_input_2" readonly="readonly" required>
					</div>
					<div class="input-box">
						<span class="details">Phone Number</span> <input id="tel" name="tel" placeholder="예)010-1111-2222" autocomplete="off" required>
					</div>
					<div class="input-box">
						<span class="details"></span> <input type="text" placeholder="상세주소 입력" name="addr3" class="address_input_3" readonly="readonly" required>
					</div>
				</div> <!-- user-details의 끝 -->
				<div class="gender-details">
					<input type="radio" name="gender" id="dot-1" value="남자"> <input type="radio" name="gender" id="dot-2" value="여자"> <span class="gender-title">Gender</span>
					<div class="category">
						<label for="dot-1"><span class="dot one"></span>
						<input type="radio" class="dot one" name="gender" value="남자" checked="checked" /> 남자</label>
