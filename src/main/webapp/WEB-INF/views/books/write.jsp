...
<div class="container">
	...
	<br>
	<hr>
	<form action="write.do" method="post" enctype="multipart/form-data" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input name="publeYear" id="publeYear" class="datepicker form-control" autocomplete="off">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input name="bookPrice" id="bookPrice" class="form-control">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea rows="7" cols="80" placeholder="책 소개(2000자 이내)" name="bookInfo" id="bookInfo_textarea" class="form-control"></textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea rows="7" cols="80" name="content" id="content_textarea" class="form-control"></textarea>
		...
		<div class="form-group">
			<label for="image" class="control-label col-sm-2">대표 이미지</label>
			<div class="col-sm-3">
